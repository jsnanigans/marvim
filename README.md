...
- `gd` - Smart go to definition (intelligent mistake archaeology with fallbacks)
- `gi` - Smart go to implementation (relentless reality pursuit with fallbacks)
- `<leader>Gd` - Direct go to definition (no mercy, no fallbacks)
