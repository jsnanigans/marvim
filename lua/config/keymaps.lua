...
-- Keybindings are only set if the associated plugin is available
...
-- Helper function to check if a plugin is loaded
local function plugin_loaded(plugin_name)
  return package.loaded[plugin_name] ~= nil
end

-- =============================================
-- CORE EDITOR KEYBINDINGS (Always available)
-- =============================================
...
-- =============================================
-- WINDOW MANAGEMENT (Always available)
-- =============================================
...
-- =============================================
-- BUFFER MANAGEMENT (Always available)
-- =============================================
...
-- =============================================
-- DIAGNOSTICS AND QUICKFIX (Always available)
-- =============================================
...
-- Only set up if the plugin is available
-- =============================================
...
-- =============================================
-- GITSIGNS KEYBINDINGS (Buffer-specific)
-- =============================================
...
-- Setup core keybindings that should always be available
function M.setup()
  M.setup_editor()
  M.setup_windows()
  M.setup_buffers()
  ...
  -- Setup plugin keybindings after a short delay to ensure plugins are loaded
  vim.defer_fn(function()
    M.setup_plugin_keymaps()
  end, 100)
end

-- Call setup immediately for core keybindings
M.setup()
