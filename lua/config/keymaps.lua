...
M.neotest_keys = {
  ...
  { "<leader>tc", function() require("neotest").run.run({ vim.fn.expand("%"), strategy = "dap" }) end, desc = "Debug Test Class" },
...
M.todo_comments_keys = {
  ...
  { "<leader>st", function() require("snacks").picker.grep({ pattern = "TODO|HACK|PERF|NOTE|FIX|FIXME" }) end, desc = "Todo Comments" },
  { "<leader>sT", function() require("snacks").picker.grep({ pattern = "TODO|FIX|FIXME" }) end, desc = "Todo/Fix/Fixme" },
}
...
M.luasnip_keys = {
  ...
  end, mode = { "i", "s" }, expr = true, desc = "Jump Next or Tab" },
  { "<S-Tab>", function()
    local luasnip = require("luasnip")
  ...
  end, mode = { "i", "s" }, expr = true, desc = "Jump Previous" },
}

-- Treesitter
M.treesitter_keys = {
  { "<c-space>", function() require("nvim-treesitter.incremental_selection").node_incremental() end, desc = "Increment Selection" },
  { "<bs>", function() require("nvim-treesitter.incremental_selection").node_decremental() end, mode = "v", desc = "Decrement Selection" },
}

-- Illuminate
M.illuminate_keys = {
  { "]]i", function() require("illuminate").goto_next_reference(false) end, desc = "Next Reference" },
  { "[[i", function() require("illuminate").goto_prev_reference(false) end, desc = "Prev Reference" },
}
...
function M.setup_lsp_keybindings(client, buffer)
  ...
  if is_available("snacks") then
    ...
    if snacks.picker then
      lsp_map("n", "gd", function() snacks.picker.lsp_definitions() end, { desc = "Go to Definition", nowait = true })
      lsp_map("n", "gr", function() snacks.picker.lsp_references() end, { desc = "References", nowait = true })
      lsp_map("n", "gD", function() snacks.picker.lsp_declarations() end, { desc = "Go to Declaration", nowait = true })
      lsp_map("n", "gI", function() snacks.picker.lsp_implementations() end, { desc = "Go to Implementation", nowait = true })
      lsp_map("n", "gy", function() snacks.picker.lsp_type_definitions() end, { desc = "Go to Type Definition", nowait = true })
    else
  ...
  if is_available("snacks") then
    ...
    if snacks.picker and snacks.picker.lsp_code_actions then
      lsp_map({ "n", "v" }, "<leader>ca", function() snacks.picker.lsp_code_actions() end, { desc = "Code Action" })
    else
  ...
  if is_available("snacks") then
    local snacks = require("snacks")
    if snacks.picker then
      lsp_map("n", "<leader>ds", function() snacks.picker.lsp_document_symbols() end, { desc = "Document Symbols" })
      lsp_map("n", "<leader>ws", function() snacks.picker.lsp_workspace_symbols() end, { desc = "Workspace Symbols" })
    end
  end
...
function M.setup_gitsigns_keybindings(buffer)
  ...
  git_map("n", "<leader>ghb", function() gs.blame_line({ full = true }) end, "Blame Line")
  git_map("n", "<leader>ghd", gs.diffthis, "Diff This")
  git_map("n", "<leader>ghD", function() gs.diffthis("~") end, "Diff This ~")
